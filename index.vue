        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <div
              class="
                hidden
                md:absolute md:flex md:items-center md:justify-end md:inset-y-0 md:right-0
              "
            >
...
const { t } = useI18n()
let Heading = "" //"Veterinary Nurse Training"
let subHeading = "" //"Emergency Edition"
let msg = "" //"Helping Vets  Save Pets"
const navigation = [
    {name: "Summary", href: "/pricing"},
    {name: "Detailed Notes", href: "/nurse"},

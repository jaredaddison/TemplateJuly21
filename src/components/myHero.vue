                  ...
                  <div class="mt-6">
                    <form action="#" method="POST" class="space-y-6">
                      <div>
                        ...
                        <input id="name" type="text" name="name" autocomplete="name" placeholder="Full name" required="" class="block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm border-gray-300 rounded-md" />
                      </div>

                      <div>
                        <label for="mobile-or-email" class="sr-only">Mobile number or email</label>
                        <input id="mobile-or-email" type="text" name="mobile-or-email" autocomplete="email" placeholder="Mobile number or email" required="" class="block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm border-gray-300 rounded-md" />
                      </div>

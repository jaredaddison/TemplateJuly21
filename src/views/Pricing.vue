							...
							>
								<div>
									...
									<div class="flex flex-col items-start sm:flex-row sm:items-center sm:justify-between lg:flex-col lg:items-start">
										...
										<a
											href="#"
											:class="[plan.featured ? 'bg-indigo-600 text-white hover:bg-indigo-700' : 'bg-white text-indigo-600 hover:bg-indigo-50', 'mt-6 w-full inline-block py-2 px-8 border border-transparent rounded-md shadow-sm text-center text-sm font-medium sm:mt-0 sm:w-auto lg:mt-6 lg:w-full']"
										>Buy {{ plan.title }}</a>
									</div>
								</div>
									...
									<dl class="divide-y divide-gray-200">
										...
										>
											...
											<dd class="flex items-center justify-end sm:px-4 sm:justify-center">
												<span
													v-if="typeof feature.tiers[planIndex].value === 'string'"
													:class="[feature.tiers[planIndex].featured ? 'text-indigo-600' : 'text-gray-900', 'text-sm font-medium']"
					...
					<div class="mt-24 max-w-7xl mx-auto px-8">
						<div class="w-full border-t border-gray-200 flex items-stretch">
							...
							<div
								...
								:key="plan.title"
								aria-hidden="true"
								:class="[index === plans.length - 1 ? '' : 'pr-4', '-mt-px pl-4 w-1/4']"
							>
								...
								<tbody class="divide-y divide-gray-100">
									...
									>
										...
										<td
											...
											:key="tier.title"
											:class="[index === feature.tiers.length - 1 ? 'pl-4' : 'px-4', 'relative w-1/4 py-0 text-center']"
										>
								...
								<tbody class="divide-y divide-gray-100">
									...
									>
										...
										<td
											...
											:key="tier.title"
											:class="[index === perk.tiers.length - 1 ? 'pl-4' : 'px-4', 'relative w-1/4 py-0 text-center']"
										>
											<span class="relative w-full h-full py-3">
												<CheckIcon
													v-if="tier.value === true"
					...
					<div class="xl:grid xl:grid-cols-3 xl:gap-8">
						<div class="space-y-8 xl:col-span-1">
							...
							<div class="flex space-x-6">
								<a
									v-for="socialLink in footerNavigation.social"
									:key="socialLink.name"
						...
						<div class="mt-12 grid grid-cols-2 gap-8 xl:mt-0 xl:col-span-2">
							<div class="md:grid md:grid-cols-2 md:gap-8">
								<div>
									...
									<ul class="mt-4 space-y-4">
										<li
											v-for="link in footerNavigation.solutions"
											:key="link.name"
										>
											<a
												:href="link.href"
								...
								<div class="mt-12 md:mt-0">
									...
									<ul class="mt-4 space-y-4">
										<li
											v-for="link in footerNavigation.support"
											:key="link.name"
										>
											<a
												:href="link.href"
							...
							<div class="md:grid md:grid-cols-2 md:gap-8">
								<div>
									...
									<ul class="mt-4 space-y-4">
										<li
											v-for="link in footerNavigation.company"
											:key="link.name"
										>
											<a
												:href="link.href"
